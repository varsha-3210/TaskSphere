...
const TaskDialog = ({ task }) => {
  ...
  const [openStageUpdate, setOpenStageUpdate] = useState(false);
...
const items = [
  ...
  return (
    <>
      ...
      <AddSubTask open={open} setOpen={setOpen} id={selectedTaskId} />

      <StageUpdateModal open={openStageUpdate} setOpen={setOpenStageUpdate} task={task} />
